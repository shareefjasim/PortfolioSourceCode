...
const WEAVEPage = () => {
  ...
  return (
    <div className=" px-6 lg:px-18 mt-18  ">
      ...
      {/* Static Images */}
      <img
        src="/projects/WEAVE/images/renders/Image34_000.png"
        alt="Image 34"
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-18 mb-18">
        <p className=" w-full mx-auto indent-8">
          Aiming for comprehensive integration with nature, the project is
          located on the lake’s shore extending a wooden deck to reach the other
          side of the lake. <br />
          <br />
          The building with its spaces and circulation pathways offers an
          enriched experience of the natural environment by easing accessibility
          and forming multiple viewpoints to appreciate the natural beauty.
        </p>
      ...
      <img
        src="/projects/WEAVE/images/Artboard 1.png"
        alt="Artboard 1"
      ...
      <img
        src="/projects/WEAVE/images/Artboard Sections.png"
        alt="Artboard Sections"
        className="w-full h-auto dark:invert"
      />
      ...
      <div className="flex flex-col min-h-screen z-0">
        <div className="mb-18 grid grid-cols-1 lg:grid-cols-2 gap-18  ">
          <img
            src="/projects/WEAVE/images/renders/Image45.png"
            alt="Image 45"
            className=" w-full h-auto"
          />

          <img
            src="/projects/WEAVE/images/renders/Image37.png"
            alt="Image 37"
            className=" w-full h-auto"
          />
          <img
            src="/projects/WEAVE/images/renders/Image44_000.png"
            alt="Image 44_000"
            className="w-full h-auto"
          />
          <img
            src="/projects/WEAVE/images/renders/Image44.png"
            alt="Image 44"
            className=" w-full h-auto "
          />
        </div>
